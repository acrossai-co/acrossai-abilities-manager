...
| 2026-06-23 | Feature 036: Library descriptions + full-width + wpb-access-control 1.4.0→1.6.0 bump; PATTERN-LIBRARY-ARGS-RAW-PASSTHROUGH captured (Registry `args` value-sanitization gap) | Library/Admin/UI | feature-036, library, descriptions, full-width, dep-bump, args-passthrough | WORKLOG.md |
