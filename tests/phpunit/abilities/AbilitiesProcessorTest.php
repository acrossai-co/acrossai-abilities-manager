...
class AbilitiesProcessorTest extends WP_UnitTestCase {
	...
	public function tearDown(): void {
		global $wpdb;
		$wpdb->query( "DELETE FROM {$wpdb->prefix}acrossai_abilities WHERE ability_slug LIKE 'acrossai-abilities-manager/proc-test-%'" ); // phpcs:ignore WordPress.DB.DirectDatabaseQuery
	...
	private function insert_published_db( array $overrides = array() ): int {
		...
		$defaults = array(
			'ability_slug'  => 'acrossai-abilities-manager/proc-test-' . $counter,
	...
	public function test_register_abilities_skips_row_with_empty_description() {
		...
		$wpdb->insert( // phpcs:ignore WordPress.DB.DirectDatabaseQuery
			$wpdb->prefix . 'acrossai_abilities',
			array(
				'ability_slug'  => 'acrossai-abilities-manager/proc-test-no-desc',
		...
		$wpdb->delete(
			$wpdb->prefix . 'acrossai_abilities',
			array( 'ability_slug' => 'acrossai-abilities-manager/proc-test-no-desc' )
		); // phpcs:ignore WordPress.DB.DirectDatabaseQuery
	}
