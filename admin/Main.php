...
class Main {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, \ACROSSAI_ABILITIES_MANAGER_PLUGIN_URL . 'build/css/backend.css', $this->css_asset_file['dependencies'], $this->css_asset_file['version'], 'all' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, \ACROSSAI_ABILITIES_MANAGER_PLUGIN_URL . 'build/js/backend.js', $this->js_asset_file['dependencies'], $this->js_asset_file['version'], false );
	}
}
