...
class Theme_Helpers {
	...
	public static function get_all_themes( string $status_filter = 'all' ): array {
		...
		foreach ( $themes as $theme ) {
			...
			$actions[] = array(
				...
				'action'       => 'acrossai-abilities-manager/activate-theme',
	...
	public static function activate_theme_by_slug( string $theme_identifier ): array {
		...
		if ( $resolved['certainty'] < 8.0 ) {
			return self::build_candidate_response(
				$resolved,
				$theme_identifier,
				'acrossai-abilities-manager/activate-theme',
	...
	public static function delete_theme_by_slug( string $theme_identifier ): array {
		...
		if ( $resolved['certainty'] < 8.0 ) {
			return self::build_candidate_response(
				$resolved,
				$theme_identifier,
				'acrossai-abilities-manager/delete-theme',
	 ...
	 * @param string $action_id      Ability action ID (e.g. "acrossai-abilities-manager/activate-theme").
